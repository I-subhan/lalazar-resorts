...
class DeluxRoom extends StatefulWidget {
  ...
  @override
  State<DeluxRoom> createState() => _DeluxRoomState();
}

class _DeluxRoomState extends State<DeluxRoom> {
  ...
  void initState() {
   ...
   roomProvider.fetchRooms(
        ...
        cityId: widget.cityId, category: RoomCategory.Deluxe, checkIn: widget.checkIn, checkOut: widget.checkOut);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<RoomProvider>(builder: (context,roomProvider,child){
        if(roomProvider.loading) return const Center(child: CircularProgressIndicator());
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          Consumer<RoomProvider>(builder: (context,roomProvider,child){
                            ...
                            Button(
                              ...
                              onTap: () => roomProvider.bookRoom(
                                ...
                                if (result == 'already_selected') {
                                  Utils().toastMessage('You already selected this room');
                                }
